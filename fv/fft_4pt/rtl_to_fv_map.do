...
# Generated on: Thu Oct 30 14:19:23 IST 2025 (Thu Oct 30 08:49:23 UTC 2025)
...
set_log_file fv/fft_4pt/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/fft_4pt -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  fft4.v
elaborate_design -golden -root {fft_4pt} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/fft_4pt/fv_map.v.gz
elaborate_design -revised -root {fft_4pt}
...
#add_name_alias fv/fft_4pt/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/fft_4pt/rtl_to_fv_map.log
}
